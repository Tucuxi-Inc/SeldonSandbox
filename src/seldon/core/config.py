...
class ExperimentConfig:
    ...
    needs_config: dict[str, Any] = field(default_factory=lambda: {
        ...
        "warning_suffering_per_tick": 0.005,
        "critical_suffering_per_tick": 0.015,
        "critical_health_damage_per_tick": 0.02,
        "lethal_suffering_per_tick": 0.04,
        "lethal_health_damage_per_tick": 0.06,
        "health_recovery_rate": 0.03,
        "health_mortality_threshold": 0.4,
        "needs_mortality_multiplier": 0.2,
        "burnout_decay_amplifier": 0.15,
    })
